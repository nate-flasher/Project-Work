...
def showAll(flightsD):
    for airlineKey in flightsD:
        print(airlineKey)
        for flightNumKey in flightsD[airlineKey]:
            print(str(flightNumKey).rjust(8), flightsD[airlineKey][flightNumKey][0][0].rjust(5),  str(flightsD[airlineKey][flightNumKey][0][1].rjust(5))


def flightsForGivenAirline(flightsD,airlineName):
              pass
