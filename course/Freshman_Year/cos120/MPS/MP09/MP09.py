...
def listKingingMoves(board,player):
    crowningMoves=[]
    crowningRow="A"
    possibleMoves=listValidMoves(board,player)
    if player=="r":
        crowningRow="H"
    for move in possibleMoves:
        if move[3]==crowningRow:
            crowningMoves.append(move)
    return crowningMoves        
...
def checkersMain(inFileName):
    ...
    if player=="b":
        ...
        move = P2.getValidMove(board,player) #get the first move
